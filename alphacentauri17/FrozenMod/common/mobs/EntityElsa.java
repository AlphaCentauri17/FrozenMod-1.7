...
int f = MathHelper.floor_double(this.posY - 1F);
        ...
        if (this.worldObj.getBlockMetadata(j, k, l) == 0 && Blocks.snow_layer.canPlaceBlockAt(this.worldObj, j, k, l))
        {
         ...
         if (this.worldObj.getBlockMetadata(j, n, l) == 0 && this.worldObj.getBiomeGenForCoords(j, l).getFloatTemperature(i, f, j) < .4F && Blocks.ice.canPlaceBlockOnSide(this.worldObj, j, m, n, l))
        {
            this.worldObj.setBlock(j, n, l, Blocks.ice);}
         
         else if (this.worldObj.getBlockMetadata(j, f, l) == 9)
         {
         	this.worldObj.setBlock(j, f, l, Blocks.ice);}
        }
